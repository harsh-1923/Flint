...
const UserHome = () => {
  ...
  const createWS = () => {
    const data = { email: authContext.user.email, title: title };
    WorkspaceServices.createWS(data).then((data) => {
      // console.log(data);
      // getAllWS();
    });
    setTitle("");
        ...
        <div className="container-right">
          <div className="banner-1">
            ...
            >
              ...
              <Avatar className="user-avatar-img" img={authContext.user.link} />
            </div>
          </div>
